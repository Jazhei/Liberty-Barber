    ...
    <div className="min-h-screen bg-transparent">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/dashboard')}>
              ...
              <span className="font-bold text-xl text-gray-900 tracking-tight">Liberty Barber</span>
            </div>
            <div className="flex items-center gap-4">
              ...
              <Button variant="secondary" onClick={handleLogout} className="text-sm py-1.5 px-4 rounded-full border-gray-200 hover:bg-red-50 hover:text-red-600 hover:border-red-100 transition-colors">
                Cerrar Sesión
              </Button>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="mb-8 animate-fade-in-up">
          ...
          <p className="text-gray-500 mt-2 text-lg">¿Qué te gustaría gestionar hoy en tu barbería?</p>
        </div>
